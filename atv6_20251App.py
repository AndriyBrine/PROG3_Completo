...
def main():
  ...
  conjunto = atv6_20251Mod.f_preencheListaRand(10000)
  ...
  conjunto = atv6_20251Mod.f_ordenaCrescente(conjunto)

  posS1,contS1 = atv6_20251Mod.f_buscaSequencialAlterada(conjunto, val1)

  posS2,contS2 = atv6_20251Mod.f_buscaSequencialAlterada(conjunto, val2)

  posS3,contS3 = atv6_20251Mod.f_buscaSequencialAlterada(conjunto, val3)

  posS4,contS4 = atv6_20251Mod.f_buscaSequencialAlterada(conjunto, val4)
  ...
  posB1,contB1 = atv6_20251Mod.f_buscaBinariaAlterada(conjunto, val1)

  posB2,contB2 = atv6_20251Mod.f_buscaBinariaAlterada(conjunto, val2)

  posB3,contB3 = atv6_20251Mod.f_buscaBinariaAlterada(conjunto, val3)

  posB4,contB4 = atv6_20251Mod.f_buscaBinariaAlterada(conjunto, val4)
